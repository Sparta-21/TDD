...
public class UserService {
    ...
    // 회원 닉네임 수정
    @Transactional
    public UserResponseDto updateUserNickname(Long userId, UserNicknameRequestDto requestDto) {
        User user = getUserById(userId);
    ...
    // 회원 비밀번호 수정
    @Transactional
    public UserResponseDto updateUserPassword(Long userId, UserPasswordRequestDto requestDto) {
        User user = getUserById(userId);
